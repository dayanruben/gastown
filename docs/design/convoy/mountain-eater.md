...
> **Related**: [roadmap.md](roadmap.md) | [spec.md](spec.md) | swarm architecture
...
The swarm architecture design describes a model where swarms are persistent
molecules coordinated by a dedicated agent. The Mountain-Eater achieves the
same outcome through a different mechanism:
